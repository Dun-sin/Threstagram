...
export function DefaultNumber({ index }: NumberProps) {
  ...
  return (
    <div className='relative'>
      <div
        className={`min-h-[337.5px] max-h-[337.5px] h-[337.5px] min-w-[270px] max-w-[270px] w-[270px]flex justify-between flex-col px-4 py-2 snap-center overflow-y-auto instagram-${index}`}
        id='card-container'
        style={{
...
export function NumberOne({ index }: NumberProps) {
  ...
  return (
    <div className='relative'>
      <div
        className={`min-h-[337.5px] max-h-[337.5px] h-[337.5px] min-w-[270px] max-w-[270px] w-[270px] flex justify-between flex-col px-4 py-2 snap-center instagram-${index} overflow-y-auto`}
        key={index}
        style={{
          background: backgroundColor(color),
          fontFamily,
